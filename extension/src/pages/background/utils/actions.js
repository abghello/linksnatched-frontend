...
function _htmlElementAsString(el, keyAttrs) {
  ...
  var keyAttrPairs = (
    (_a = keyAttrs) === null || _a === void 0 ? void 0 : _a.length
  )
    ? keyAttrs
...
function addExceptionMechanism(event, newMechanism) {
  ...
  exceptionValue0.mechanism = __assign(
  ...
  if (newMechanism && 'data' in newMechanism) {
    var mergedData = __assign(
      __assign(
        {},
        (_a = currentMechanism) === null || _a === void 0 ? void 0 : _a.data
      ),
      newMechanism.data
    );
...
function checkOrSetAlreadyCaught(exception) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
  if (
    (_a = exception) === null || _a === void 0 ? void 0 : _a.__sentry_captured__
  ) {
    return true;
  }
  try {
...
var Scope = /** @class */ (function () {
  ...
  Scope.prototype.setTag = function (key, value) {
    var _a;
    this._tags = __assign$1(
      __assign$1({}, this._tags),
      ((_a = {}), (_a[key] = value), _a)
    );
    this._notifyScopeListeners();
    return this;
  ...
  Scope.prototype.setExtra = function (key, extra) {
    var _a;
    this._extra = __assign$1(
      __assign$1({}, this._extra),
      ((_a = {}), (_a[key] = extra), _a)
    );
    this._notifyScopeListeners();
    return this;
  ...
  Scope.prototype.setContext = function (key, context) {
    ...
    if (context === null) {
      ...
      this._contexts = __assign$1(
        __assign$1({}, this._contexts),
  ...
  Scope.prototype.getTransaction = function () {
    ...
    if (
      (_d =
        (_c = span) === null || _c === void 0 ? void 0 : _c.spanRecorder) ===
        null || _d === void 0
        ? void 0
        : _d.spans[0]
    ) {
  ...
  Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
    ...
    var mergedBreadcrumb = __assign$1(
  ...
  Scope.prototype.applyToEvent = function (event, hint) {
    ...
    if (this._span) {
      ...
      var transactionName =
        (_a = this._span.transaction) === null || _a === void 0
          ? void 0
          : _a.name;
      if (transactionName) {
...
var Hub = /** @class */ (function () {
  ...
  Hub.prototype.captureException = function (exception, hint) {
    ...
    this._invokeClient(
      'captureException',
      exception,
      __assign$1(__assign$1({}, finalHint), { event_id: eventId })
    );
    return eventId;
  };
  /**
  ...
  Hub.prototype.captureEvent = function (event, hint) {
    ...
    this._invokeClient(
      'captureEvent',
      event,
      __assign$1(__assign$1({}, hint), { event_id: eventId })
    );
    return eventId;
  };
  /**
  ...
  Hub.prototype.endSession = function () {
    ...
    (_c =
      (_b =
        (_a = this.getStackTop()) === null || _a === void 0
          ? void 0
          : _a.scope) === null || _b === void 0
        ? void 0
    ...
    (_e =
      (_d = this.getStackTop()) === null || _d === void 0
        ? void 0
        : _d.scope) === null || _e === void 0
      ? void 0
      : _e.setSession();
  };
  /**
...
function getHubFromActiveDomain(registry) {
  ...
  try {
    var activeDomain =
      (_c =
        (_b =
          (_a = getMainCarrier().__SENTRY__) === null || _a === void 0
            ? void 0
            : _a.extensions) === null || _b === void 0
          ? void 0
...
function savedIcon() {
  ...
  context.fillStyle = '#4169E1'; // Royal blue background
  context.fillRect(0, 0, 128, 128);

  // Create the "L" shape path
  let iconPath = new Path2D('M32 32 L32 96 L96 96 L96 80 L48 80 L48 32 Z');

  // Fill the "L" with white color
...
function inactiveIcon() {
  ...
  // Fill background with light gray/white color
  context.fillStyle = '#F5F5F5'; // Light gray background
  context.fillRect(0, 0, 128, 128);

  // Create the "L" shape path
  let iconPath = new Path2D('M24 24 L24 104 L104 104 L104 80 L48 80 L48 24 Z');

  // Fill the "L" with blue color
  context.fillStyle = '#2E5BBA'; // Medium blue color
  context.fill(iconPath, 'evenodd');

  // Optional: Add a subtle border around the entire icon
  ...
  return new Promise((resolve, reject) => {
    chrome.storage.local.get([key], (result) => {
      if (chrome.runtime.lastError) {
        ...
        return reject(
          'Error when retrieving local settings. Please contact Linksnatched Support'
        );
      }
  ...
  return new Promise((resolve, reject) => {
    chrome.storage.local.set(values, () => {
      if (chrome.runtime.lastError) {
        handleSettingError(chrome.runtime.lastError);
        return reject(
          'Error when storing local settings. Please contact Linksnatched Support'
        );
      }
...
const LOGGED_OUT_OF_LINKSNATCHED = 'LOGGED_OUT_OF_LINKSNATCHED';
const OPEN_LINKSNATCHED = 'OPEN_LINKSNATCHED';
const AUTH_CODE_RECEIVED = 'AUTH_CODE_RECEIVED';
const COLOR_MODE_CHANGE = 'COLOR_MODE_CHANGE';
const OPEN_OPTIONS = 'OPEN_OPTIONS';
const SAVE_TO_LINKSNATCHED_REQUEST = 'SAVE_TO_LINKSNATCHED_REQUEST';
const SAVE_TO_LINKSNATCHED_SUCCESS = 'SAVE_TO_LINKSNATCHED_SUCCESS';
const SAVE_TO_LINKSNATCHED_FAILURE = 'SAVE_TO_LINKSNATCHED_FAILURE';
...
const TOOLBAR_ICON_UPDATE = 'TOOLBAR_ICON_UPDATE';

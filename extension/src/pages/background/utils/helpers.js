import { getSetting } from './actions.js';
import { LINKSNATCHED_HOME } from './constants.js';
...
function displayTitle(item) {
  return (
    ...
    (item === null || item === void 0 ? void 0 : item.resolved_title) ||
    (item === null || item === void 0 ? void 0 : item.given_title) ||
    (item === null || item === void 0 ? void 0 : item.display_url) ||
...
function displayPublisher(item) {
  ...
  const urlToUse =
    (item === null || item === void 0 ? void 0 : item.given_url) ||
    (item === null || item === void 0 ? void 0 : item.resolved_url);
  const derivedDomain = domainForUrl(urlToUse);
  return (
    (item === null || item === void 0
      ? void 0
      : (_item$domain_metadata = item.domain_metadata) === null ||
        _item$domain_metadata === void 0
      ? void 0
      : _item$domain_metadata.name) ||
    (item === null || item === void 0 ? void 0 : item.domain) ||
    derivedDomain ||
    null
  );
}
...
function displayThumbnail(item) {
  ...
  return (
    (item === null || item === void 0 ? void 0 : item.top_image_url) ||
    (item === null || item === void 0
      ? void 0
      : (_item$image = item.image) === null || _item$image === void 0
      ? void 0
      : _item$image.src) ||
    (item === null || item === void 0
      ? void 0
      : (_item$images = item.images) === null || _item$images === void 0
      ? void 0
      : (_item$images$Object$k = _item$images[Object.keys(item.images)[0]]) ===
          null || _item$images$Object$k === void 0
      ? void 0
      : _item$images$Object$k.src) ||
    null
  );
}
/**
